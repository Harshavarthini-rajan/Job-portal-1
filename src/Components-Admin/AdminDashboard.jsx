...
import AdminMon from '../assets/AdminAssets/AdminMon.png'
import AdminMonAct from '../assets/AdminAssets/AdminMonAct.png'
import CompanyApp from '../assets/AdminAssets/CompanyApp.png'
import CompanyAppAct from '../assets/AdminAssets/CompanyAppAct.png'
            ...
            <div className='AdminContainer'>
                <div className='Admin-Sidebar'>
                    ...
                    <div className='Admin-Sidebar-list'>
                        ...
                        <div>
                            <div onClick={() => {
                                const isOpening = openSubMenu !== "activity";
                                setOpenSubMenu(isOpening ? "activity" : null);
                                if (isOpening) {setActiveTab("Admin Monitoring"); }
                            }}
                                className={activetab === "Activity Monitoring" || activetab === "Admin Monitoring" || activetab === "Company Approval" ? "Admin-Active" : "Admin-Navbar"}>
                                <div className="Admin-Navbox"> {activetab === "Activity Monitoring" ? 
                                    (<img src={ActivityMonAct} width={15} height={15} alt="" />) 
                                    :(<img src={ActivityMon} width={15} height={15} alt="" />)}
                                    <div className="Enav-item">Activity Monitoring</div>
                                </div>
                            </div>
                            {openSubMenu === "activity" && (
                                <div className="Admin-Submenu">
                                    <div onClick={() => setActiveTab("Admin Monitoring")} className={activetab === "Admin Monitoring" ? "Admin-SubActive" : "Admin-SubItem"}>
                                        <div className="Admin-Navbox"><img src={activetab === "Admin Monitoring" ? AdminMonAct : AdminMon}width={15}height={15}alt=""/>
                                            <span>Admin Monitoring</span>
                                        </div>
                                    </div>
                                    <div onClick={() => setActiveTab("Company Approval")}className={activetab === "Company Approval"? "Admin-SubActive": "Admin-SubItem"}>
                                        <div className="Admin-Navbox"><img src={activetab === "Company Approval" ? CompanyAppAct: CompanyApp}width={15}height={15}alt=""/>
                ...
                <div className='Admin-MainSec'>
                    ...
                    {activetab === 'Admin Monitoring' && (<AdminMonitoring />)}
